...
export const locations: Location[] = [
  {
    ...
    schedule: [
      ...
      { day: 'Tuesday', time: '6:30 AM - 2:00 PM', dayIndex: 2 },
      { day: 'Wednesday', time: '6:30 AM - 2:00 PM', dayIndex: 3 },
      { day: 'Thursday', time: '6:30 AM - 2:00 PM', dayIndex: 4 },
      { day: 'Friday', time: '6:30 AM - 2:00 PM', dayIndex: 5 },
      { day: 'Saturday', time: '6:30 AM - 2:00 PM', dayIndex: 6 },
    ],
  },
  {
    id: 'mission-hills',
