...
const cateringPackages: CateringPackage[] = [
  {
    ...
    extras: [
      {
        name: "Large Guacamole Bowl",
        price: "$75",
      },
      {
        name: "Aguas Frescas (5 gallons)",
        price: "$50 each",
        note: "Horchata, Pineapple, Hibiscus",
      },
    ],
  },
  {
...
const Catering = () => {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      const selectedPackageId = String(
      ...
      const submissionData = {
        ...
        headcount: String(formData.get("headcount") || "").trim(),
        eventType: String(formData.get("eventType") || "").trim(),
        package: selectedPackage?.name || selectedPackageId,
      ...
      if (!result.success) {
        throw new Error(
          result.error ||
            result.message ||
            "Unable to send catering request."
        );
      }
      ...
      console.error(
        "Catering form submission error:",
        error
      );
      ...
      toast({
        ...
        description:
          `${errorMessage} Please try again or call us directly at 818-272-9961.`,
        variant: "destructive",
      });
    } finally {
      setIsSubmitting(false);
  ...
  return (
    <>
      <Helmet>
        <title>
          Catering | Big Art's Tacos y Burros | Chatsworth
        </title>

        <meta
          name="description"
          content="Cater your next event with Big Art's Tacos y Burros. Breakfast burritos, tacos, and Cafe de Olla for parties, corporate events, and gatherings in Chatsworth."
        />

        <meta
          property="og:title"
          content="Catering | Big Art's Tacos y Burros"
        />
        ...
        <meta
          property="og:url"
          content="https://bigartstacos.com/catering"
        />

        <meta
          property="og:image"
          content="https://storage.googleapis.com/gpt-engineer-file-uploads/TwFfdXtj9KPaUtTHoCvbqEoYX6D3/social-images/social-1768502479604-bigarts-logo.png"
        />

        <meta
          property="og:site_name"
          content="Big Art's Tacos y Burros"
        />
        ...
        <link
          rel="canonical"
          href="https://bigartstacos.com/catering"
        />
      </Helmet>
      ...
      <main className="pt-24 pb-20 lg:pb-0 bg-foreground">
        ...
        <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden">
          <div className="absolute inset-0">
            <img
              src={salsaBar}
              alt="Big Art's Tacos catering salsa bar setup"
          ...
          <div className="relative z-10 container-tight mx-auto px-4 sm:px-6 text-center">
            ...
            <p className="text-primary-foreground/80 text-lg max-w-2xl mx-auto">
              From office breakfasts to backyard parties, we bring
              the full Big Art's experience to you.
            </p>
          </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              <div>
                ...
                <div className="space-y-4 text-muted-foreground mb-8">
                  <p>
                    Whether it's a corporate breakfast meeting, a
                    birthday brunch, a wedding celebration, or just
                    a good excuse to get together, we've got you
                    covered.
                  </p>

                  <p>
                    Our catering includes everything you need:
                    fresh-made breakfast burritos, street tacos,
                    sides, salsas, and of course, our signature
                    Cafe de Olla.
                  </p>
                ...
                <div className="bg-muted rounded-2xl p-4 sm:p-6 space-y-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <a
                      ...
                      className="flex items-center gap-3 p-3 bg-background rounded-xl hover:shadow-soft transition-shadow"
                    >
                    ...
                    {/* Email */}
                    <a
                      href="mailto:info@bigartstacos.com"
                      className="flex items-center gap-3 p-3 bg-background rounded-xl hover:shadow-soft transition-shadow"
                    >
                      <div className="p-2 bg-primary/10 rounded-lg">
                ...
                <p className="text-muted-foreground text-sm mt-8">
                  Travel fee applies for events outside of the San
                  Fernando Valley.
                </p>
              </div>
                ...
                {isSubmitted ? (
                  ...
                  >
                    ...
                    <p className="text-xs text-muted-foreground text-center">
                      ...
                      urgent requests, DM us on Instagram.
                    </p>
